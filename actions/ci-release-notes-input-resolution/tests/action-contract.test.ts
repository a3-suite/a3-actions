...
// integration_id: ci-release-notes-input-resolution-action-contract
test('action.yml matches the checked-in public contract fixture', () => {
  ...
  const contract = JSON.parse(fs.readFileSync(path.join(__dirname, 'ci-release-notes-input-resolution-contract.json'), 'utf8')) as any;
